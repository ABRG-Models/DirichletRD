pair<float,float> v1 = make_pair (-0.40f, -0.6f); 
pair<float,float> v2 = make_pair (0.4f, -0.6f);
pair<float,float> v3 = make_pair (0.40f, 0.6f); 
pair<float,float> v4 = make_pair (-0.4f, 0.6f); 
