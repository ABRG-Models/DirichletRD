...
//     ///////////////
//     double sc= sqrt(0.75);
//     centres[0].xval=-0.06748*sc; centres[].yval=0.3829*sc;
//     centres[1].xval=0.0589*sc; centres[1].yval=0.4221*sc;
//     centres[2].xval=0.1718*sc; centres[2].yval=0.4248*sc;y);
...
//     centres[28].xval=0.0941*sc; centres[28]=-0.0589*sc;
...
//     xval[46].xval=-0.1154*sc; centres[46].yval=-0.1104*sc;
...
//start of code for determining colour scale
	    ...
	    //code below only relevant for one domain case
	     // rayv.resize(0);
	    //  ringv.resize(0);
            //  for (int i=0;i<M.n;i++)
